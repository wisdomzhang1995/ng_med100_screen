"""
Django settings for ng_med100_screen project.
...
SECRET_KEY = 'django-insecure-q(@nyb==6+@*xtj(gtz@iw@b*c@1$o60h_dx=tz2*azt4-5txn'
...
WSGI_APPLICATION = 'ng_med100_screen.wsgi.application'
